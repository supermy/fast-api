...
public class PdfUtilitiesTest {
    ...
    private final String testResourcesDataPath = "/Users/moyong/project/env-myopensource/1-spring/12-spring/fast-api/d-api/app-consuming-rest/src/test/resources/test-data";
    ...
    public void testMergePdf() {
        ...
        int expResult = 6;
        File outputPdfFile = new File("/Users/moyong/project/env-myopensource/1-spring/12-spring/fast-api/d-api/app-consuming-rest/src/test/resources/test-results", "multipage-pdf_merged.pdf");
